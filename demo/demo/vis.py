...
from model.MSTPFormer import MSTPFormer
...
def get_pose3D(video_path, output_dir):
    ...
    args.n_layers, args.dim_in, args.dim_feat, args.dim_rep, args.dim_out = 13, 3, 128, 512, 3
    ...
    ## Reload 
    model = nn.DataParallel(MSTPFormer(**args)).cuda()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--video', type=str, default='Posing.mp4', help='input video')
